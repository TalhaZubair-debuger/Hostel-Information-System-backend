...
], isAuth, uploadImage.single("image"), hostelController.addHostel);
...
//User Routes
router.get("/hostels", isAuth, hostelController.getAllHostels);
...
router.get('/hostel/:hostelId', isAuth, hostelController.getHostel);
